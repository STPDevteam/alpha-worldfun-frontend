...
export interface DoubleArrowUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DoubleArrowUpIcon = React.forwardRef<SVGSVGElement, DoubleArrowUpIconProps>(
