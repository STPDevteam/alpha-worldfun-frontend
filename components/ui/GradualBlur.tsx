...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      const configWithResponsive = config as Record<string, string | undefined>;
      if (w <= 480 && configWithResponsive['mobile' + k]) v = configWithResponsive['mobile' + k];
      else if (w <= 768 && configWithResponsive['tablet' + k]) v = configWithResponsive['tablet' + k];
      else if (w <= 1024 && configWithResponsive['desktop' + k]) v = configWithResponsive['desktop' + k];
      setVal(v);
    };
...
(GradualBlurMemo as typeof GradualBlurMemo & { PRESETS: typeof PRESETS; CURVE_FUNCTIONS: typeof CURVE_FUNCTIONS }).PRESETS = PRESETS;
(GradualBlurMemo as typeof GradualBlurMemo & { PRESETS: typeof PRESETS; CURVE_FUNCTIONS: typeof CURVE_FUNCTIONS }).CURVE_FUNCTIONS = CURVE_FUNCTIONS;
